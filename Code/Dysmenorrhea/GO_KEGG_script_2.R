...
setwd("/Users/ti19522/Downloads/bluecrystal_files/results/Dysmenorrhea/ewaff") # Set working directory to the file where the ewaff data is pulled from BC
...
load("dysmen_ewas.Rdata")
load("dysmen_DMRres.Rdata")
load("dysmen_EWAScatEnrichmentres.Rdata")
