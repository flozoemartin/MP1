...
Pheno <- read.csv(file.path("/newhome/ti19522/EWAS/alspac_menstruation_project", "Pheno_comorbidrm.csv"),stringsAsFactors=FALSE)

# Load cell-counts
cells <- read.table(paste0("/panfs/panasas01/dedicated-mrcieu/studies/latest/alspac/epigenetic/methylation/450k/aries/released/2016-05-03/data/derived/cellcounts/houseman/data.txt"), header=TRUE)
